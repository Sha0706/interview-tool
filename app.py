...
if not st.session_state.setup_complete:
    ...
    st.session_state["company"] = st.selectbox(
          "Choose a Company",
          ("Amazon", "Meta", "Udemy", "Accenture", "Zoho", "Nestle", "LinkedIn", "Spotify")
    ) 
...
if st.session_state.setup_complete and not st.session_state.feedback_shown and not st.session_state.chat_complete:
    ...
    if not  st.session_state.messages:
        st.session_state.messages = [{
             ...
             f"with experience {st.session_state['experience']} and skills{st.session_state['skills']}.you should interview them for the position {st.session_state['level']} {st.session_state['position']} at the Company {st.session_state['company'] }")
        }]
...
if st.session_state.feedback_shown:
     ...
     feedback_completion = feedback_client.chat.completions.create(
          ...
          messages=[
              ...
              Give only the Feedback do not ask any return questions.
                """},
